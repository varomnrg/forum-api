...
describe("DomainErrorTranslator", () => {
    it("should translate error correctly", () => {
        ...
        expect(DomainErrorTranslator.translate(new Error("NEW_THREAD.NOT_CONTAIN_NEEDED_PROPERTY"))).toStrictEqual(new InvariantError("gagal memasukan, harus memberikan judul dan isi"));
        expect(DomainErrorTranslator.translate(new Error("NEW_THREAD.NOT_MEET_DATA_TYPE_SPECIFICATION"))).toStrictEqual(new InvariantError("title dan body harus string"));
        expect(DomainErrorTranslator.translate(new Error("NEW_COMMENT.NOT_CONTAIN_NEEDED_PROPERTY"))).toStrictEqual(new InvariantError("tidak dapat membuat komentar baru karena properti yang dibutuhkan tidak ada"));
        expect(DomainErrorTranslator.translate(new Error("NEW_COMMENT.NOT_MEET_DATA_TYPE_SPECIFICATION"))).toStrictEqual(new InvariantError("content, owner, dan threadId harus string"));
        expect(DomainErrorTranslator.translate(new Error("DELETE_COMMENT_USE_CASE.NOT_CONTAIN_NEEDED_PROPERTY"))).toStrictEqual(new InvariantError("harus mengirimkan threadId, commentId, dan owner"));
        expect(DomainErrorTranslator.translate(new Error("DELETE_COMMENT_USE_CASE.NOT_MEET_DATA_TYPE_SPECIFICATION"))).toStrictEqual(new InvariantError("threadId, commentId, dan owner harus string"));
        expect(DomainErrorTranslator.translate(new Error("DELETE_REPLY_USE_CASE.NOT_CONTAIN_NEEDED_PROPERTY"))).toStrictEqual(new InvariantError("harus mengirimkan threadId, commentId, replyId, dan owner"));
        expect(DomainErrorTranslator.translate(new Error("DELETE_REPLY_USE_CASE.NOT_MEET_DATA_TYPE_SPECIFICATION"))).toStrictEqual(new InvariantError("threadId, commentId, replyId, dan owner harus string"));
        expect(DomainErrorTranslator.translate(new Error("NEW_REPLY.NOT_MEET_DATA_TYPE_SPECIFICATION"))).toStrictEqual(new InvariantError("content, owner, dan commentId harus string"));
        expect(DomainErrorTranslator.translate(new Error("NEW_REPLY.NOT_CONTAIN_NEEDED_PROPERTY"))).toStrictEqual(new InvariantError("tidak dapat membuat balasan baru karena properti yang dibutuhkan tidak ada"));
    });
